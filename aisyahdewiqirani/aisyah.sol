...
contract AisyahDewiQirani is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor()
        ERC721("Aisyah Dewi Qirani", "AISYAH")
        EIP712("Aisyah Dewi Qirani", "1")
    {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://github.com/agussaifuddin/nft/blob/main/aisyahdewiqirani/metadata.json";
    }
